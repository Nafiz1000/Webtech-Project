...
<strong>
		...
		<a href="Eventlist.php">Event</a>
		<a href="Costing&Discount.php">Costing & Discount</a>
		<a href="Bookinglist.php">Booking List</a>
		<a href="EmployeeList.php">Employee List</a>
		<a href="AssignEmployee.php">Assaign Employee</a>
		<a href="HallSuggestion.php">Hall Info</a>
		<a href="BookedHallList.php">Booked HAll</a>
